...
bids_root  = '/Users/bolger/Documents/work/Projects/Project_SyntaxDyn_EGI/SyntaxDyn_hd'    # Root directory
deriv_root = '/Users/bolger/Documents/work/Projects/Project_SyntaxDyn_EGI/SyntaxDyn_hd/derivatives'
...
## Define the minimum/maximum epoch time
epochs_tim = -0.25
epochs_tmax = 1.000
baseline = (None, 0)
conditions = ['rouge', 'venimeuse']
contrasts = [('adj', 'adv')]
